...
    const shareFacebookBtn = document.getElementById('share-facebook-btn'); // CORREÇÃO: ID do botão do Facebook
...
            
            if (!response.ok) {
                const errorResponse = await response.text(); // Pega o texto do erro
